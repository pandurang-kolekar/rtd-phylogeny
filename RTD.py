...
Script to compute RTDs for nucleotide / protein sequences
...
parser.add_argument("--seqType", default='N', help="Type of input sequences, either Nucleotide (N) or Protein (P)", choices = ['N', 'P'])
parser.add_argument("--kmerSize", default=1, help="Size of k-mer to compute return time distributions (RTDs)", type=int, required=True, choices = [1,2,3,4,5,6,7])
parser.add_argument('--version', action='version', version='RTD v1.0.1')
